...
- <img src="https://upload.wikimedia.org/wikipedia/commons/4/4e/Angularjsoldicon.png" height="25px" alt="Angular Logo"/> SneakerHub - MVC + Services web app with REST API, form types, validators, interceptors, guards, modules, pipes and tokens
